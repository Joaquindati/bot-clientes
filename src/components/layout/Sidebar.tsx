...
import { LayoutDashboard, Search, Users, Settings, LogOut, Map } from 'lucide-react';
  ...
  return (
    <div className="flex h-full w-64 flex-col bg-white border-r border-gray-200 dark:bg-zinc-900 dark:border-zinc-800">
      ...
      <div className="border-t border-gray-200 p-4 dark:border-zinc-800">
        ...
        <button className="mt-1 group flex w-full items-center rounded-md px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20">
